...
/**
 * Abstraction of an entity which represents the functionality of linkName.
 */
public interface LinkName {

    /**
     * Identify the leaf of LinkName.
     */
    ...
    /**
     * Builder for linkName.
     */
    interface LinkNameBuilder {
        /**
         * Returns the attribute valueName.
         *
         * @return valueName value of valueName
         ...
         * @return valueName
         */
        LinkNameBuilder valueName(String valueName);
         ...
         * @return value
         */
        LinkNameBuilder value(String value);
         ...
         */
        LinkNameBuilder localClassRef(String localClassRef);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        LinkNameBuilder addYangAugmentedInfo(Object value, Class classObject);
