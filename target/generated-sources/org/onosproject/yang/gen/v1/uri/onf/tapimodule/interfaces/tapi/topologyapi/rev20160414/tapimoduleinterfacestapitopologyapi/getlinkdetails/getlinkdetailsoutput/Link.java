...
public interface Link {
    ...
    interface LinkBuilder {
         ...
         */
        LinkBuilder addToNodeRefList(Object addTo);
         ...
         */
        LinkBuilder addToLayerProtocolNameList(TapiLayerProtocolName addTo);
         ...
         */
        LinkBuilder addToLinkPortList(LinkPortList addTo);
         ...
         */
        LinkBuilder addToLocalIdList(LocalIdList addTo);
         ...
         */
        LinkBuilder addToName(Name addTo);
         ...
         */
        LinkBuilder addToLabel(Label addTo);
         ...
         */
        LinkBuilder addToExtension(Extension addTo);
         ...
         */
        LinkBuilder linkDirection(TapiLinkDirection linkDirection);
         ...
         * @return uuid
         */
        LinkBuilder uuid(UniversalId uuid);
         ...
         * @return nodeRefList
         */
        LinkBuilder nodeRefList(List<Object> nodeRefList);
         ...
         */
        LinkBuilder layerProtocolNameList(List<TapiLayerProtocolName> layerProtocolNameList);
         ...
         * @return linkPortList
         */
        LinkBuilder linkPortList(List<LinkPortList> linkPortList);
         ...
         */
        LinkBuilder riskParameterPac(RiskParameterPac riskParameterPac);
         ...
         */
        LinkBuilder transferCostPac(TransferCostPac transferCostPac);
         ...
         */
        LinkBuilder transferTimingPac(TransferTimingPac transferTimingPac);
         ...
         */
        LinkBuilder transferCapacityPac(TransferCapacityPac transferCapacityPac);
         ...
         */
        LinkBuilder transferIntegrityPac(TransferIntegrityPac transferIntegrityPac);
         ...
         */
        LinkBuilder validationPac(ValidationPac validationPac);
         ...
         * @return localIdList
         */
        LinkBuilder localIdList(List<LocalIdList> localIdList);
         ...
         * @return name
         */
        LinkBuilder name(List<Name> name);
         ...
         * @return label
         */
        LinkBuilder label(List<Label> label);
         ...
         * @return extension
         */
        LinkBuilder extension(List<Extension> extension);
         ...
         * @return statePac
         */
        LinkBuilder statePac(StatePac statePac);
