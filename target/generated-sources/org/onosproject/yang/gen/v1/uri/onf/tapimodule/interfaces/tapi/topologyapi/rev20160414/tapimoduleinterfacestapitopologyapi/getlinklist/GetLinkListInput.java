...
/**
 * Abstraction of an entity which represents the functionality of getLinkListInput.
 */
public interface GetLinkListInput {

    /**
     * Identify the leaf of GetLinkListInput.
     */
    ...
    /**
     * Builder for getLinkListInput.
     */
    interface GetLinkListInputBuilder {
        /**
         * Adds to the list of layerProtocolNameList.
         *
         * @return builder object of layerProtocolNameList
         */
        GetLinkListInputBuilder addToLayerProtocolNameList(TapiLayerProtocolName addTo);
         ...
         * @return topologyId
         */
        GetLinkListInputBuilder topologyId(UniversalId topologyId);
         ...
         */
        GetLinkListInputBuilder layerProtocolNameList(List<TapiLayerProtocolName> layerProtocolNameList);
         ...
         * @return topologyName
         */
        GetLinkListInputBuilder topologyName(TopologyName topologyName);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        GetLinkListInputBuilder addYangAugmentedInfo(Object value, Class classObject);
        ...
        Object yangAugmentedInfo(Class classObject);
        /**
         * Builds object of getLinkListInput.
         *
         * @return getLinkListInput
         */
        GetLinkListInput build();
    }
}
