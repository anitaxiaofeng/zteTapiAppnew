...
/**
 * Abstraction of an entity which represents the functionality of nodeName.
 */
public interface NodeName {

    /**
     * Identify the leaf of NodeName.
     */
    ...
    /**
     * Builder for nodeName.
     */
    interface NodeNameBuilder {
        /**
         * Returns the attribute valueName.
         *
         * @return valueName value of valueName
         ...
         * @return valueName
         */
        NodeNameBuilder valueName(String valueName);
         ...
         * @return value
         */
        NodeNameBuilder value(String value);
         ...
         */
        NodeNameBuilder localClassRef(String localClassRef);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        NodeNameBuilder addYangAugmentedInfo(Object value, Class classObject);
