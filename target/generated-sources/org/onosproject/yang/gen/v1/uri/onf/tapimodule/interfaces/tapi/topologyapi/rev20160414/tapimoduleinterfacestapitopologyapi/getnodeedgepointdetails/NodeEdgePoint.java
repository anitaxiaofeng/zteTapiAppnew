...
/**
 * Abstraction of an entity which represents the functionality of nodeEdgePoint.
 */
public interface NodeEdgePoint {

    /**
     * Identify the leaf of NodeEdgePoint.
     */
    ...
    /**
     * Builder for nodeEdgePoint.
     */
    interface NodeEdgePointBuilder {
        /**
         * Adds to the list of serviceEprefList.
         *
         * @return builder object of serviceEprefList
         */
        NodeEdgePointBuilder addToServiceEprefList(Object addTo);
         ...
         */
        NodeEdgePointBuilder addToClientConnEprefList(Object addTo);
         ...
         */
        NodeEdgePointBuilder addToPhysicalPortReference(String addTo);
         ...
         */
        NodeEdgePointBuilder addToLpList(LpList addTo);
         ...
         */
        NodeEdgePointBuilder addToLocalIdList(LocalIdList addTo);
         ...
         */
        NodeEdgePointBuilder addToName(Name addTo);
         ...
         */
        NodeEdgePointBuilder addToLabel(Label addTo);
         ...
         */
        NodeEdgePointBuilder addToExtension(Extension addTo);
         ...
         */
        NodeEdgePointBuilder terminationDirection(TapiTerminationDirection terminationDirection);
         ...
         */
        NodeEdgePointBuilder serverConnEpref(Object serverConnEpref);
         ...
         * @return uuid
         */
        NodeEdgePointBuilder uuid(UniversalId uuid);
         ...
         */
        NodeEdgePointBuilder serviceEprefList(List<Object> serviceEprefList);
         ...
         */
        NodeEdgePointBuilder clientConnEprefList(List<Object> clientConnEprefList);
         ...
         */
        NodeEdgePointBuilder physicalPortReference(List<String> physicalPortReference);
         ...
         * @return lpList
         */
        NodeEdgePointBuilder lpList(List<LpList> lpList);
         ...
         * @return localIdList
         */
        NodeEdgePointBuilder localIdList(List<LocalIdList> localIdList);
         ...
         * @return name
         */
        NodeEdgePointBuilder name(List<Name> name);
         ...
         * @return label
         */
        NodeEdgePointBuilder label(List<Label> label);
         ...
         * @return extension
         */
        NodeEdgePointBuilder extension(List<Extension> extension);
         ...
         * @return statePac
         */
        NodeEdgePointBuilder statePac(StatePac statePac);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        NodeEdgePointBuilder addYangAugmentedInfo(Object value, Class classObject);
        ...
        Object yangAugmentedInfo(Class classObject);
        /**
         * Builds object of nodeEdgePoint.
         *
