...
/**
 * Abstraction of an entity which represents the functionality of nodeEpname.
 */
public interface NodeEpname {

    /**
     * Identify the leaf of NodeEpname.
     */
    ...
    /**
     * Builder for nodeEpname.
     */
    interface NodeEpnameBuilder {
        /**
         * Returns the attribute valueName.
         *
         * @return valueName value of valueName
         ...
         * @return valueName
         */
        NodeEpnameBuilder valueName(String valueName);
         ...
         * @return value
         */
        NodeEpnameBuilder value(String value);
         ...
         */
        NodeEpnameBuilder localClassRef(String localClassRef);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        NodeEpnameBuilder addYangAugmentedInfo(Object value, Class classObject);
