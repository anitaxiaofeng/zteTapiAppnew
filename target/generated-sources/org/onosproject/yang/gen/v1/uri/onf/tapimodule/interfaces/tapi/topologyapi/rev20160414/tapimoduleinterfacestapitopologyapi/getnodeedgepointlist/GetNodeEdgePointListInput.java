...
package org.onosproject.yang.gen.v1.uri.onf.tapimodule.interfaces.tapi.topologyapi.rev20160414
            .tapimoduleinterfacestapitopologyapi.getnodeedgepointlist;

import java.util.BitSet;
import java.util.List;
import java.util.Map;
import org.onosproject.yang.gen.v1.uri.onf.tapimodule.interfaces.tapi.topologyapi.rev20160414
            .tapimoduleinterfacestapitopologyapi.getnodeedgepointlist.getnodeedgepointlistinput.NodeName;
import org.onosproject.yang.gen.v1.uri.onf.tapimodule.interfaces.tapi.topologyapi.rev20160414
            .tapimoduleinterfacestapitopologyapi.getnodeedgepointlist.getnodeedgepointlistinput.TopologyName;
...
/**
 * Abstraction of an entity which represents the functionality of getNodeEdgePointListInput.
 */
public interface GetNodeEdgePointListInput {

    /**
     * Identify the leaf of GetNodeEdgePointListInput.
     */
    ...
    /**
     * Builder for getNodeEdgePointListInput.
     */
    interface GetNodeEdgePointListInputBuilder {
        /**
         * Adds to the list of layerProtocolNameList.
         *
         * @return builder object of layerProtocolNameList
         */
        GetNodeEdgePointListInputBuilder addToLayerProtocolNameList(TapiLayerProtocolName addTo);
         ...
         * @return topologyId
         */
        GetNodeEdgePointListInputBuilder topologyId(UniversalId topologyId);
         ...
         * @return nodeId
         */
        GetNodeEdgePointListInputBuilder nodeId(UniversalId nodeId);
         ...
         */
        GetNodeEdgePointListInputBuilder layerProtocolNameList(List<TapiLayerProtocolName> layerProtocolNameList);
         ...
         * @return topologyName
         */
        GetNodeEdgePointListInputBuilder topologyName(TopologyName topologyName);
         ...
         * @return nodeName
         */
        GetNodeEdgePointListInputBuilder nodeName(NodeName nodeName);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        GetNodeEdgePointListInputBuilder addYangAugmentedInfo(Object value, Class classObject);
        ...
        Object yangAugmentedInfo(Class classObject);
        /**
         * Builds object of getNodeEdgePointListInput.
         *
         * @return getNodeEdgePointListInput
         */
        GetNodeEdgePointListInput build();
    }
}
