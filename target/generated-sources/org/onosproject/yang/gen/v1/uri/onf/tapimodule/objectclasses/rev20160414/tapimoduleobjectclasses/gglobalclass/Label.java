...
public interface Label {
    ...
    /**
     * Returns the attribute yangLabelOpType.
     *
     * @return yangLabelOpType value of yangLabelOpType
     */
    OnosYangOpType yangLabelOpType();
    ...
    interface LabelBuilder {
         ...
         * @return valueName
         */
        LabelBuilder valueName(String valueName);
         ...
         * @return value
         */
        LabelBuilder value(String value);
         ...
         */
        LabelBuilder localClassRef(String localClassRef);

        /**
         * Returns the builder object of yangLabelOpType.
         *
         * @param yangLabelOpType value of yangLabelOpType
         * @return yangLabelOpType
         */
        LabelBuilder yangLabelOpType(OnosYangOpType yangLabelOpType);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        LabelBuilder addYangAugmentedInfo(Object value, Class classObject);
         ...
         */
        LabelBuilder selectLeaf(LeafIdentifier leaf);
