...
/**
 * Abstraction of an entity which represents the functionality of extension.
 */
public interface Extension {

    /**
     * Identify the leaf of Extension.
     */
    ...
    /**
     * Returns the attribute yangExtensionOpType.
     *
     * @return yangExtensionOpType value of yangExtensionOpType
     */
    OnosYangOpType yangExtensionOpType();
    ...
    interface ExtensionBuilder {
         ...
         * @return valueName
         */
        ExtensionBuilder valueName(String valueName);
         ...
         * @return value
         */
        ExtensionBuilder value(String value);
         ...
         */
        ExtensionBuilder localClassRef(String localClassRef);

        /**
         * Returns the builder object of yangExtensionOpType.
         *
         * @param yangExtensionOpType value of yangExtensionOpType
         * @return yangExtensionOpType
         */
        ExtensionBuilder yangExtensionOpType(OnosYangOpType yangExtensionOpType);
         ...
         * @param classObject value of yangAugmentedInfo
         */
        ExtensionBuilder addYangAugmentedInfo(Object value, Class classObject);
         ...
         */
        ExtensionBuilder selectLeaf(LeafIdentifier leaf);
