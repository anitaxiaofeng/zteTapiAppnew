...
/**
 * Represents the implementation of routeList.
 *
 * <p>
 ...
 * </p>
 */
public class DefaultRouteList implements RouteList {
    protected String localId;
    protected List<Object> lowerFcRefList;
    protected BitSet valueLeafFlags = new BitSet();
    protected OnosYangOpType yangRouteListOpType;
    ...
    @Override
    public List<Object> lowerFcRefList() {
    ...
    @Override
    public OnosYangOpType yangRouteListOpType() {
    ...
    @Override
    public int hashCode() {
         return Objects.hash(localId, lowerFcRefList, valueLeafFlags, yangRouteListOpType, isSubTreeFiltered,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultRouteList) {
            DefaultRouteList other = (DefaultRouteList) obj;
            return
                Objects.equals(localId, other.localId) &&
                Objects.equals(lowerFcRefList, other.lowerFcRefList) &&
                Objects.equals(valueLeafFlags, other.valueLeafFlags) &&
                Objects
                .equals(yangRouteListOpType,
                 other.yangRouteListOpType) &&
    ...
    public String toString() {
        return MoreObjects.toStringHelper(getClass())
            .omitNullValues()
            .add("localId", localId)
            .add("lowerFcRefList", lowerFcRefList)
            .add("valueLeafFlags", valueLeafFlags)
            .add("yangRouteListOpType", yangRouteListOpType)
    ...
    /**
     * Creates an instance of routeList.
     *
     * @param builderObject value of builder object of routeList
     */
    protected DefaultRouteList(RouteListBuilder builderObject) {
        localId = builderObject.localId();
        lowerFcRefList = builderObject.lowerFcRefList();
        valueLeafFlags = builderObject.valueLeafFlags();
        yangRouteListOpType = builderObject.yangRouteListOpType();
    ...
    /**
     * Checks if the passed RouteList maps the content match query condition.
     *
     * @param appInstance appInstance being passed to check for content match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    public DefaultRouteList processSubtreeFiltering(RouteList appInstance, boolean isSelectAllSchemaChild) {
        RouteListBuilder subTreeFilteringResultBuilder = new RouteListBuilder();
        ...
        return (DefaultRouteList) subTreeFilteringResultBuilder.buildForFilter();
    }

    private boolean processLeafSubtreeFiltering(RouteList appInstance, RouteListBuilder
    ...
    private boolean processLeafListSubTreeFiltering(RouteList appInstance, RouteListBuilder
                subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode, boolean
                isSelectAllSchemaChild) {
        if (isSelectAllSchemaChild) {
            if (appInstance.lowerFcRefList() != null) {
                for (Object lowerFcRefList : appInstance.lowerFcRefList()) {
                    subTreeFilteringResultBuilder.addToLowerFcRefList(lowerFcRefList);
                }
            } else {
                if (isSubTreeFiltered && lowerFcRefList() != null) {
                    subTreeFilteringResultBuilder.lowerFcRefList(lowerFcRefList);
                }
            }
        } else if (lowerFcRefList() != null) {
            if (!lowerFcRefList().isEmpty()) {
                if (appInstance.lowerFcRefList() == null || appInstance.lowerFcRefList().isEmpty()) {
                    return false;
                }
                for (Object lowerFcRefList : lowerFcRefList()) {
                    boolean flag = false;
                    for (Object lowerFcRefList2 : appInstance.lowerFcRefList()) {
                        if (lowerFcRefList.equals(lowerFcRefList2)) {
                            flag = true;
                            subTreeFilteringResultBuilder.addToLowerFcRefList(lowerFcRefList2);
                            break;
                        }
                    }
                    if (!flag) {
    ...
    private boolean processChildNodesSubTreeFiltering(RouteList appInstance, RouteListBuilder
                subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode, boolean
                isSelectAllSchemaChild) {
        if (isSelectAllSchemaChild) {
    ...
    /**
     * Creates an instance of defaultRouteList.
     */
    protected DefaultRouteList() {
    }

    /**
     * Returns the attribute routeListBuilder.
     *
     * @return routeListBuilder
     */
    public static RouteListBuilder builder() {
    ...
    /**
     * Represents the builder implementation of routeList.
     */
    public static class RouteListBuilder implements RouteList.RouteListBuilder {
        protected String localId;
        protected List<Object> lowerFcRefList;
        protected BitSet valueLeafFlags = new BitSet();
        protected OnosYangOpType yangRouteListOpType;
        ...
        @Override
        public RouteListBuilder localId(String localId) {
        ...
        @Override
        public RouteListBuilder lowerFcRefList(List<Object> lowerFcRefList) {
            this.lowerFcRefList = lowerFcRefList;
            return this;
        }

        @Override
        public RouteListBuilder yangRouteListOpType(OnosYangOpType yangRouteListOpType) {
            this.yangRouteListOpType = yangRouteListOpType;
            return this;
        }
        /**
         ...
         * @return isSubTreeFiltered
         */
        public RouteListBuilder isSubTreeFiltered(boolean isSubTreeFiltered) {
            this.isSubTreeFiltered = isSubTreeFiltered;
            return this;
        }

        @Override
        public RouteListBuilder localIdList(List<LocalIdList> localIdList) {
            this.localIdList = localIdList;
            return this;
        }

        @Override
        public RouteListBuilder name(List<Name> name) {
            this.name = name;
            return this;
        }

        @Override
        public RouteListBuilder label(List<Label> label) {
            this.label = label;
            return this;
        }

        @Override
        public RouteListBuilder extension(List<Extension> extension) {
            this.extension = extension;
            return this;
        }

        @Override
        public RouteListBuilder statePac(StatePac statePac) {
            this.statePac = statePac;
            return this;
        }

        @Override
        public RouteListBuilder addToLowerFcRefList(Object addTo) {
            if (lowerFcRefList == null) {
                lowerFcRefList = new ArrayList<>();
            }
            lowerFcRefList.add(addTo);
            return this;
        }


        @Override
        public RouteListBuilder addToLocalIdList(LocalIdList addTo) {
            if (localIdList == null) {
        ...
        @Override
        public RouteListBuilder addToName(Name addTo) {
            if (name == null) {
                name = new ArrayList<>();
            }
            name.add(addTo);
        ...
        @Override
        public RouteListBuilder addToLabel(Label addTo) {
            if (label == null) {
                label = new ArrayList<>();
            }
            label.add(addTo);
        ...
        @Override
        public RouteListBuilder addToExtension(Extension addTo) {
            if (extension == null) {
        ...
        @Override
        public RouteListBuilder selectLeaf(LeafIdentifier leaf) {
            selectLeafFlags.set(leaf.getLeafIndex());
            return this;
        }

        @Override
        public RouteListBuilder addYangAugmentedInfo(Object value, Class classObject) {
        ...
        public RouteList build() {
            return new DefaultRouteList(this);
        }
         ...
         * @return routeList
         */
        public RouteList buildForFilter() {
            isSubTreeFiltered = true;
            return new DefaultRouteList(this);
        }
        /**
         * Creates an instance of routeListBuilder.
         */
