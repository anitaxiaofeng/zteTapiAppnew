...
/**
 * Represents the implementation of broadcastFilteringTraffic.
 *
 * <p>
 ...
 * </p>
 */
public class DefaultBroadcastFilteringTraffic implements BroadcastFilteringTraffic {
    ...
    protected OnosYangOpType yangBroadcastFilteringTrafficOpType;
    ...
    @Override
    public OnosYangOpType yangBroadcastFilteringTrafficOpType() {
    ...
    @Override
    public int hashCode() {
         return Objects.hash(cir, cbs, eir, ebs, colourMode, valueLeafFlags, yangBroadcastFilteringTrafficOpType,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultBroadcastFilteringTraffic) {
            DefaultBroadcastFilteringTraffic other = (DefaultBroadcastFilteringTraffic) obj;
            return
                ...
                Objects
                .equals(yangBroadcastFilteringTrafficOpType,
                 other.yangBroadcastFilteringTrafficOpType) &&
    ...
    public String toString() {
        return MoreObjects.toStringHelper(getClass())
            ...
            .add("yangBroadcastFilteringTrafficOpType", yangBroadcastFilteringTrafficOpType)
    ...
    /**
     * Creates an instance of broadcastFilteringTraffic.
     *
     * @param builderObject value of builder object of broadcastFilteringTraffic
     */
    protected DefaultBroadcastFilteringTraffic(BroadcastFilteringTrafficBuilder builderObject) {
        ...
        yangBroadcastFilteringTrafficOpType = builderObject.yangBroadcastFilteringTrafficOpType();
    ...
    /**
     * Checks if the passed BroadcastFilteringTraffic maps the content match query condition.
     *
     * @param appInstance appInstance being passed to check for content match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    public DefaultBroadcastFilteringTraffic processSubtreeFiltering(BroadcastFilteringTraffic appInstance, boolean
                isSelectAllSchemaChild) {
        BroadcastFilteringTrafficBuilder subTreeFilteringResultBuilder = new BroadcastFilteringTrafficBuilder();
        ...
        return (DefaultBroadcastFilteringTraffic) subTreeFilteringResultBuilder.buildForFilter();
    }

     private boolean processLeafSubtreeFiltering(BroadcastFilteringTraffic appInstance,
                BroadcastFilteringTrafficBuilder subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode,
     ...
     private boolean processChildNodesSubTreeFiltering(BroadcastFilteringTraffic appInstance,
                BroadcastFilteringTrafficBuilder subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode,
                boolean isSelectAllSchemaChild) {
        return true;
    }
    ...
    /**
     * Creates an instance of defaultBroadcastFilteringTraffic.
     */
    protected DefaultBroadcastFilteringTraffic() {
    }

    /**
     * Returns the attribute broadcastFilteringTrafficBuilder.
     *
     * @return broadcastFilteringTrafficBuilder
     */
    public static BroadcastFilteringTrafficBuilder builder() {
        return new BroadcastFilteringTrafficBuilder();
    }
    ...
    /**
     * Represents the builder implementation of broadcastFilteringTraffic.
     */
    public static class BroadcastFilteringTrafficBuilder implements
                BroadcastFilteringTraffic.BroadcastFilteringTrafficBuilder {
        protected Integer cir;
        protected Integer cbs;
        protected Integer eir;
        protected Integer ebs;
        ...
        @Override
        public BroadcastFilteringTrafficBuilder cir(Integer cir) {
        ...
        @Override
        public BroadcastFilteringTrafficBuilder cbs(Integer cbs) {
        ...
        @Override
        public BroadcastFilteringTrafficBuilder eir(Integer eir) {
        ...
        @Override
        public BroadcastFilteringTrafficBuilder ebs(Integer ebs) {
        ...
        @Override
        public BroadcastFilteringTrafficBuilder colourMode(TapiColourMode colourMode) {
        ...
        @Override
        public BroadcastFilteringTrafficBuilder yangBroadcastFilteringTrafficOpType(OnosYangOpType
                    yangBroadcastFilteringTrafficOpType) {
            this.yangBroadcastFilteringTrafficOpType = yangBroadcastFilteringTrafficOpType;
            return this;
        }
        /**
         ...
         * @return isSubTreeFiltered
         */
        public BroadcastFilteringTrafficBuilder isSubTreeFiltered(boolean isSubTreeFiltered) {
            this.isSubTreeFiltered = isSubTreeFiltered;
            return this;
        }

        @Override
        public BroadcastFilteringTrafficBuilder selectLeaf(LeafIdentifier leaf) {
            selectLeafFlags.set(leaf.getLeafIndex());
            return this;
        }

        @Override
        public BroadcastFilteringTrafficBuilder addYangAugmentedInfo(Object value, Class classObject) {
        ...
        @Override
        public BroadcastFilteringTraffic build() {
            return new DefaultBroadcastFilteringTraffic(this);
        }
         ...
         */
        public BroadcastFilteringTraffic buildForFilter() {
            isSubTreeFiltered = true;
            return new DefaultBroadcastFilteringTraffic(this);
        }
        /**
         * Creates an instance of broadcastFilteringTrafficBuilder.
         */
        public BroadcastFilteringTrafficBuilder() {
        }
