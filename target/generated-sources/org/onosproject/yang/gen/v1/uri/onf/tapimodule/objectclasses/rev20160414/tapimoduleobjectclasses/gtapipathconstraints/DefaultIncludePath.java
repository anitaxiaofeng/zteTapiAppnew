...
/**
 * Represents the implementation of includePath.
 *
 * <p>
 ...
 * </p>
 */
public class DefaultIncludePath implements IncludePath {
    protected Object nodeRef;
    protected Object linkPortRef;
    protected Object linkRef;
    protected BitSet valueLeafFlags = new BitSet();
    protected OnosYangOpType yangIncludePathOpType;
    ...
    @Override
    public OnosYangOpType yangIncludePathOpType() {
        return yangIncludePathOpType;
    }
    /**
    ...
    @Override
    public int hashCode() {
         return Objects.hash(nodeRef, linkPortRef, linkRef, valueLeafFlags, yangIncludePathOpType, isSubTreeFiltered,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultIncludePath) {
            DefaultIncludePath other = (DefaultIncludePath) obj;
            return
                ...
                Objects
                .equals(yangIncludePathOpType,
                 other.yangIncludePathOpType) &&
    ...
    public String toString() {
        return MoreObjects.toStringHelper(getClass())
            ...
            .add("yangIncludePathOpType", yangIncludePathOpType)
    ...
    /**
     * Creates an instance of includePath.
     *
     * @param builderObject value of builder object of includePath
     */
    protected DefaultIncludePath(IncludePathBuilder builderObject) {
        nodeRef = builderObject.nodeRef();
        linkPortRef = builderObject.linkPortRef();
        linkRef = builderObject.linkRef();
        valueLeafFlags = builderObject.valueLeafFlags();
        yangIncludePathOpType = builderObject.yangIncludePathOpType();
    ...
    /**
     * Checks if the passed IncludePath maps the content match query condition.
     *
     * @param appInstance appInstance being passed to check for content match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    public DefaultIncludePath processSubtreeFiltering(IncludePath appInstance, boolean isSelectAllSchemaChild) {
        IncludePathBuilder subTreeFilteringResultBuilder = new IncludePathBuilder();
        ...
        return (DefaultIncludePath) subTreeFilteringResultBuilder.buildForFilter();
    }

    private boolean processLeafSubtreeFiltering(IncludePath appInstance, IncludePathBuilder
    ...
    private boolean processChildNodesSubTreeFiltering(IncludePath appInstance, IncludePathBuilder
                subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode, boolean
                isSelectAllSchemaChild) {
        return true;
    }
    ...
    /**
     * Creates an instance of defaultIncludePath.
     */
    protected DefaultIncludePath() {
    }

    /**
     * Returns the attribute includePathBuilder.
     *
     * @return includePathBuilder
     */
    public static IncludePathBuilder builder() {
        return new IncludePathBuilder();
    }
    ...
    /**
     * Represents the builder implementation of includePath.
     */
    public static class IncludePathBuilder implements IncludePath.IncludePathBuilder {
        protected Object nodeRef;
        protected Object linkPortRef;
        protected Object linkRef;
        protected BitSet valueLeafFlags = new BitSet();
        ...
        @Override
        public IncludePathBuilder nodeRef(Object nodeRef) {
        ...
        @Override
        public IncludePathBuilder linkPortRef(Object linkPortRef) {
        ...
        @Override
        public IncludePathBuilder linkRef(Object linkRef) {
        ...
        @Override
        public IncludePathBuilder yangIncludePathOpType(OnosYangOpType yangIncludePathOpType) {
            this.yangIncludePathOpType = yangIncludePathOpType;
            return this;
        }
        /**
         ...
         * @return isSubTreeFiltered
         */
        public IncludePathBuilder isSubTreeFiltered(boolean isSubTreeFiltered) {
            this.isSubTreeFiltered = isSubTreeFiltered;
            return this;
        }

        @Override
        public IncludePathBuilder selectLeaf(LeafIdentifier leaf) {
            selectLeafFlags.set(leaf.getLeafIndex());
            return this;
        }

        @Override
        public IncludePathBuilder addYangAugmentedInfo(Object value, Class classObject) {
        ...
        @Override
        public IncludePath build() {
            return new DefaultIncludePath(this);
        }

        /**
         * Builds object of includePath.
         *
         * @return includePath
         */
        public IncludePath buildForFilter() {
            isSubTreeFiltered = true;
            return new DefaultIncludePath(this);
        }
        /**
         * Creates an instance of includePathBuilder.
         */
        public IncludePathBuilder() {
        }
