...
/**
 * Represents the implementation of servicePortList.
 *
 * <p>
 ...
 * </p>
 */
public class DefaultServicePortList implements ServicePortList {
    protected Object serviceEndPointRef;
    protected Object connectionEndPointRef;
    protected TapiRole role;
    protected String localId;
    protected BitSet valueLeafFlags = new BitSet();
    protected OnosYangOpType yangServicePortListOpType;
    ...
    @Override
    public Object serviceEndPointRef() {
        return serviceEndPointRef;
    }

    @Override
    public Object connectionEndPointRef() {
    ...
    @Override
    public OnosYangOpType yangServicePortListOpType() {
    ...
    @Override
    public int hashCode() {
         return Objects.hash(serviceEndPointRef, connectionEndPointRef, role, localId, valueLeafFlags,
                    yangServicePortListOpType, isSubTreeFiltered, selectLeafFlags, yangAugmentedInfoMap,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultServicePortList) {
            DefaultServicePortList other = (DefaultServicePortList) obj;
            return
                Objects.equals(serviceEndPointRef, other.serviceEndPointRef) &&
                Objects.equals(connectionEndPointRef, other.connectionEndPointRef) &&
                Objects.equals(role, other.role) &&
                Objects.equals(localId, other.localId) &&
                Objects.equals(valueLeafFlags, other.valueLeafFlags) &&
                Objects
                .equals(yangServicePortListOpType,
                 other.yangServicePortListOpType) &&
    ...
    public String toString() {
        return MoreObjects.toStringHelper(getClass())
            .omitNullValues()
            .add("serviceEndPointRef", serviceEndPointRef)
            .add("connectionEndPointRef", connectionEndPointRef)
            .add("role", role)
            .add("localId", localId)
            .add("valueLeafFlags", valueLeafFlags)
            .add("yangServicePortListOpType", yangServicePortListOpType)
    ...
    /**
     * Creates an instance of servicePortList.
     *
     * @param builderObject value of builder object of servicePortList
     */
    protected DefaultServicePortList(ServicePortListBuilder builderObject) {
        serviceEndPointRef = builderObject.serviceEndPointRef();
        connectionEndPointRef = builderObject.connectionEndPointRef();
        role = builderObject.role();
        localId = builderObject.localId();
        valueLeafFlags = builderObject.valueLeafFlags();
        yangServicePortListOpType = builderObject.yangServicePortListOpType();
    ...
    /**
     * Checks if the passed ServicePortList maps the content match query condition.
     *
     * @param appInstance appInstance being passed to check for content match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    public DefaultServicePortList processSubtreeFiltering(ServicePortList appInstance, boolean
                isSelectAllSchemaChild) {
        ServicePortListBuilder subTreeFilteringResultBuilder = new ServicePortListBuilder();
        ...
        return (DefaultServicePortList) subTreeFilteringResultBuilder.buildForFilter();
    }

    private boolean processLeafSubtreeFiltering(ServicePortList appInstance, ServicePortListBuilder
                subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode, boolean
                isSelectAllSchemaChild) {
        if (valueLeafFlags.get(LeafIdentifier.SERVICEENDPOINTREF.getLeafIndex())) {
             if (appInstance.serviceEndPointRef() == null
                        || !(serviceEndPointRef()
            .equals(appInstance.serviceEndPointRef()))) {
                if (isSubTreeFiltered && !appInstance.isLeafValueSet(LeafIdentifier.SERVICEENDPOINTREF)) {
                    subTreeFilteringResultBuilder.serviceEndPointRef(serviceEndPointRef());
                } else {
                    return false;
                }
            } else {
                subTreeFilteringResultBuilder.serviceEndPointRef(appInstance.serviceEndPointRef());
            }
        } else if (selectLeafFlags.get(LeafIdentifier.SERVICEENDPOINTREF.getLeafIndex()) || isSelectAllSchemaChild) {
            isAnySelectOrContainmentNode.set(0);
            subTreeFilteringResultBuilder.serviceEndPointRef(appInstance.serviceEndPointRef());
        }

        if (valueLeafFlags.get(LeafIdentifier.CONNECTIONENDPOINTREF.getLeafIndex())) {
             if (appInstance.connectionEndPointRef() == null
                        || !(connectionEndPointRef()
            .equals(appInstance.connectionEndPointRef()))) {
                if (isSubTreeFiltered && !appInstance.isLeafValueSet(LeafIdentifier.CONNECTIONENDPOINTREF)) {
                    subTreeFilteringResultBuilder.connectionEndPointRef(connectionEndPointRef());
                } else {
                    return false;
                }
            } else {
                subTreeFilteringResultBuilder.connectionEndPointRef(appInstance.connectionEndPointRef());
            }
        } else if
                    (selectLeafFlags.get(LeafIdentifier.CONNECTIONENDPOINTREF
            .getLeafIndex()) ||
                    isSelectAllSchemaChild) {
            isAnySelectOrContainmentNode.set(0);
            subTreeFilteringResultBuilder.connectionEndPointRef(appInstance.connectionEndPointRef());
    ...
    private boolean processChildNodesSubTreeFiltering(ServicePortList appInstance, ServicePortListBuilder
                subTreeFilteringResultBuilder, BitSet isAnySelectOrContainmentNode, boolean
                isSelectAllSchemaChild) {
    ...
    /**
     * Creates an instance of defaultServicePortList.
     */
    protected DefaultServicePortList() {
    }

    /**
     * Returns the attribute servicePortListBuilder.
     *
     * @return servicePortListBuilder
     */
    public static ServicePortListBuilder builder() {
        return new ServicePortListBuilder();
    }
    ...
    /**
     * Represents the builder implementation of servicePortList.
     */
    public static class ServicePortListBuilder implements ServicePortList.ServicePortListBuilder {
        protected Object serviceEndPointRef;
        protected Object connectionEndPointRef;
        protected TapiRole role;
        protected String localId;
        ...
        @Override
        public ServicePortListBuilder serviceEndPointRef(Object serviceEndPointRef) {
            valueLeafFlags.set(LeafIdentifier.SERVICEENDPOINTREF.getLeafIndex());
            this.serviceEndPointRef = serviceEndPointRef;
            return this;
        }

        @Override
        public ServicePortListBuilder connectionEndPointRef(Object connectionEndPointRef) {
            valueLeafFlags.set(LeafIdentifier.CONNECTIONENDPOINTREF.getLeafIndex());
            this.connectionEndPointRef = connectionEndPointRef;
            return this;
        }

        @Override
        public ServicePortListBuilder role(TapiRole role) {
        ...
        @Override
        public ServicePortListBuilder localId(String localId) {
        ...
        @Override
        public ServicePortListBuilder yangServicePortListOpType(OnosYangOpType yangServicePortListOpType) {
            this.yangServicePortListOpType = yangServicePortListOpType;
            return this;
        }
        /**
         ...
         * @return isSubTreeFiltered
         */
        public ServicePortListBuilder isSubTreeFiltered(boolean isSubTreeFiltered) {
            this.isSubTreeFiltered = isSubTreeFiltered;
            return this;
        }

        @Override
        public ServicePortListBuilder localIdList(List<LocalIdList> localIdList) {
            this.localIdList = localIdList;
            return this;
        }

        @Override
        public ServicePortListBuilder name(List<Name> name) {
            this.name = name;
            return this;
        }

        @Override
        public ServicePortListBuilder label(List<Label> label) {
            this.label = label;
            return this;
        }

        @Override
        public ServicePortListBuilder extension(List<Extension> extension) {
            this.extension = extension;
            return this;
        }

        @Override
        public ServicePortListBuilder statePac(StatePac statePac) {
            this.statePac = statePac;
            return this;
        }

        @Override
        public ServicePortListBuilder addToLocalIdList(LocalIdList addTo) {
            if (localIdList == null) {
        ...
        @Override
        public ServicePortListBuilder addToName(Name addTo) {
            if (name == null) {
                name = new ArrayList<>();
            }
            name.add(addTo);
        ...
        @Override
        public ServicePortListBuilder addToLabel(Label addTo) {
            if (label == null) {
                label = new ArrayList<>();
            }
            label.add(addTo);
        ...
        @Override
        public ServicePortListBuilder addToExtension(Extension addTo) {
            if (extension == null) {
        ...
        @Override
        public ServicePortListBuilder selectLeaf(LeafIdentifier leaf) {
            selectLeafFlags.set(leaf.getLeafIndex());
            return this;
        }

        @Override
        public ServicePortListBuilder addYangAugmentedInfo(Object value, Class classObject) {
        ...
        @Override
        public ServicePortList build() {
            return new DefaultServicePortList(this);
        }
         ...
         */
        public ServicePortList buildForFilter() {
            isSubTreeFiltered = true;
            return new DefaultServicePortList(this);
        }
        /**
         * Creates an instance of servicePortListBuilder.
         */
        public ServicePortListBuilder() {
        }
